        ...
        <div class="font-[sans-serif] text-gray-800 bg-white max-w-4xl flex items-center mx-auto md:h-screen p-4">
            <div class="grid md:grid-cols-3 items-center shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-xl overflow-hidden">
                ...
                <form class="md:col-span-2 w-full py-6 px-6 sm:px-16">
                        ...
                        <div>
                            ...
                            <div class="relative flex items-center">
                                <input
                                    ...
                                    name="password" type="password" required class="bg-white border border-gray-300 w-full text-sm px-4 py-2.5 rounded-md outline-blue-500" placeholder="Enter password" />
                    ...
                    <div>
                        <p className=' cursor-pointer text-gray-600 font-semibold hover:underline ml-1 whitespace-nowrap' handleHomek={handleHomePageNavigation}> Go back home</p>
                    </div>
                </form>
            </div>
        </div>
