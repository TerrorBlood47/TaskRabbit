	...
	return (
		<div>
			...
			<div className='  flex justify-between h-[8vh] w-full items-baseline mt-5'>
				...
				<div className=' flex text-lg items-center gap-1 justify-between w-[30%] text-gray-400 font-bold'>
					<p className=' cursor-pointer ' onClick={handleLandingPageNavigation}>Home</p>

					<p className=' cursor-pointer ' onClick={handleServiceNavigation}>Services</p>

					<p>Reviews</p>

					<p className=' cursor-pointer ' onClick={handleAboutNavigation}>About</p>

					<p className=' cursor-pointer ' onClick={handleLoginNavigation}>Login</p>

					<p className='cursor-pointer' onClick={handleSignupNavigation}>SignUp</p>
...

				{
					...
					<div>
						<img
							...
							className='h-12 w-12 rounded-full object-cover cursor-pointer mr-12 '
							src='https://w0.peakpx.com/wallpaper/746/798/HD-wallpaper-tom-shrugz-tom-and-jerry-cat-thumbnail.jpg'
							alt=''
						></img>
					</div>
				}
			...
			{/* mid part + ad */}
			{serviceClicked && aboutClicked && LandingPageClicked}
